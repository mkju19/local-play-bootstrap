...
from managers import ExtendedBuildDetector
...
class ZoneGather2(ActBase):
    ...
    def should_hold_position(self, target_position: Point2) -> bool:
        if self.ai.time < 180 and self.build_detector.worker_rush_detected and self.ai.supply_army < 6:
            return False
