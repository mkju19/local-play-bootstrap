...
class ScoutLocation(ScoutBaseAction):
    ...
    def scout_enemy2(**kwargs) -> ScoutBaseAction:
        return ScoutLocation(lambda k: k.expansion_zones[-2].behind_mineral_position_center, **kwargs)

    @staticmethod
    def scout_enemy3(**kwargs) -> ScoutBaseAction:
        return ScoutLocation(lambda k: k.expansion_zones[-3].behind_mineral_position_center, **kwargs)

    @staticmethod
    def scout_enemy4(**kwargs) -> ScoutBaseAction:
        return ScoutLocation(lambda k: k.expansion_zones[-4].behind_mineral_position_center, **kwargs)

    @staticmethod
    def scout_enemy5(**kwargs) -> ScoutBaseAction:
        return ScoutLocation(lambda k: k.expansion_zones[-5].behind_mineral_position_center, **kwargs)

    @staticmethod
    def scout_enemy6(**kwargs) -> ScoutBaseAction:
        return ScoutLocation(lambda k: k.expansion_zones[-6].behind_mineral_position_center, **kwargs)

    @staticmethod
    def scout_enemy7(**kwargs) -> ScoutBaseAction:
        return ScoutLocation(lambda k: k.expansion_zones[-7].behind_mineral_position_center, **kwargs)

    @staticmethod
    def scout_own1(**kwargs) -> ScoutBaseAction:
        return ScoutLocation(lambda k: k.expansion_zones[0].behind_mineral_position_center, **kwargs)
